...
namespace GostCryptography.Tests
{
	public static class TestConfig
	{
		...
		static TestConfig()
		{
			...
			var gost_R3410_Certificates = new List<TestCertificateInfo>
										  {
												  gost_R3410_2001,
												  gost_R3410_2012_256,
												  gost_R3410_2012_512
		...
		public static IEnumerable<object[]> XProviders
		{
			get
			{
		...
		public static IEnumerable<object[]> XGost_R3410_Certificates
		{
			get
			{
				foreach (var item in Gost_R3410_Certificates)
				{
					yield return new object[] { item };
				}
			}
		...
		public static IEnumerable<object[]> XGost_R3410_2001_Certificates
		{
			get
			{
				foreach (var item in Gost_R3410_2001_Certificates)
				{
					yield return new object[]{item};
				}
			}
		...
		public static IEnumerable<object[]> XGost_R3410_2012_256_Certificates
		{
			get
			{
				foreach (var item in Gost_R3410_2012_256_Certificates)
				{
					yield return new object[] {item};
				}
			}
		...
		public static IEnumerable<object[]> XGost_R3410_2012_512_Certificates
		{
			get
			{
				foreach (var item in Gost_R3410_2012_512_Certificates)
				{
					yield return new object[] { item };
				}
			}
